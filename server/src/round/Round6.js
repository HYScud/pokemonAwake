...
class Round6 extends RoundBase.CRoundBase {
    constructor() {
        super();
        this.id = 6;
        this.index= "2-1";
        ...
        this.star = 0;
        this.type = 0;
        this.boss = {id:9,level:2,pos:6,rankNum:0};
        ...
        this.itemList = [{itemId:10,maxNum:2},{itemId:2,maxNum:3},{itemId:4,maxNum:3},{itemId:3,maxNum:3},{itemId:4,maxNum:3}];
        this.desc = undefined;
        this.createBoss();
