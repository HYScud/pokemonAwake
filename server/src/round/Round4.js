...
class Round4 extends RoundBase.CRoundBase {
    constructor() {
        super();
        this.id = 4;
        this.index= "1-4";
        ...
        this.star = 0;
        this.type = 1;
        this.boss = {id:9,level:2,pos:4,rankNum:0};
        ...
        this.itemList = [{itemId:11,maxNum:2},{itemId:2,maxNum:3},{itemId:3,maxNum:3},{itemId:4,maxNum:3}];
        this.desc = undefined;
        this.createBoss();
